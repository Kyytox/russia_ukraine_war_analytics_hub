...
DICT_CONTENT = {
    ...
    "Components Weapons": {
        ...
        "tags": ["Analytics", "Graphs", "External Data"],
        "color_tags": ["#961010", "#4abb15", "#821f9b"],
        "icon": "fa-cog",
    },
    "Interactive Maps": {
        "title": "Interactive Maps",
        "text": "Explore the interactive maps related to the conflict.",
        "image": "assets/images/interactive_maps.png",
        "url": "/interactive-maps",
        "tags": ["Maps", "External Data"],
